...
set "T_OPT1=Smart-Abruf - Standard (Pausiert alle 50 Tracks / Fortsetzbar)"
set "T_OPT2=Smart-Abruf - Overnight (Laeuft ohne Pausen durch / Fortsetzbar)"
set "T_OPT3=Voll-Abruf  - Reset und Overnight (Alle Tracks komplett neu)"
...
set "T_H3=--- WARTUNG ---"
set "T_OPT6=Wartung     - Massenbearbeitung (Genres, Typen, Schreibweisen, Attribute)"
...
set "T_OPT1=Smart Fetch - Standard (Pauses every 50 tracks / Resumable)"
set "T_OPT2=Smart Fetch - Overnight (Runs continuously / Resumable)"
set "T_OPT3=Full Fetch  - Reset and Overnight (Re-fetch all tracks)"
...
set "T_OPT6=Maintenance - Mass editing (Genres, Item Types, Text Case, Attributes)"
...
set "T_OPT1=Smart-Fetch - Standaard (Pauzeert elke 50 tracks / Hervatbaar)"
set "T_OPT2=Smart-Fetch - Overnight (Draait continu / Hervatbaar)"
set "T_OPT3=Full-Fetch  - Reset en Overnight (Alle tracks volledig opnieuw)"
...
set "T_H3=--- ONDERHOUD ---"
set "T_OPT6=Onderhoud   - Massabewerking (Genres, Typen, Tekst, Attributen)"
